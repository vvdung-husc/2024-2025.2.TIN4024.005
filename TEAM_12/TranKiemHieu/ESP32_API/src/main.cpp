...
#define BLYNK_TEMPLATE_ID "TMPL6nUk-Dcml"
#define BLYNK_TEMPLATE_NAME "ESP32 API HTTP"
#define BLYNK_AUTH_TOKEN "s31JcFDp5qr3SSaIYrKA-dMgXiDlYuQJ"
...
#define OPENWEATHERMAP_KEY "19c9dd5aace588a88fcbcf898d6902ce" //Thay KEY của bạn vào đây
...
void updateTemp(){
  ...
  if(httpResponseCode>0){
    ...
    if (error) {
      ...
      float temp = doc["main"]["temp"].as<float>();//lấy thông tin nhiệt độđộ
