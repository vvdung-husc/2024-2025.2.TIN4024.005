...
// Blynk credentials
#define BLYNK_TEMPLATE_ID "TMPL6HsCkbDDK"
#define BLYNK_TEMPLATE_NAME "BlynkTemperature"
#define BLYNK_AUTH_TOKEN "MI3DoBxvwHNSdMBIOhhVXlv7MU-31w3E"
...
void updateTemperatureHumidity()
{
  ...
  {
    Blynk.virtualWrite(V3, temp); // Gửi nhiệt độ lên Blynk
    Blynk.virtualWrite(V4, hum);  // Gửi độ ẩm lên Blynk
