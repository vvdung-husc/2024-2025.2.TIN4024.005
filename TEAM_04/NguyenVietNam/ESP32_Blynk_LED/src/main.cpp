...
#define BLYNK_TEMPLATE_ID "TMPL6v8C4Upx7"
#define BLYNK_TEMPLATE_NAME "ESP32 Blynk Traffic Light LED"
#define BLYNK_AUTH_TOKEN "M7IWqMyEPRdEcVZ2WBkvOTFHoSNcf0SB"
