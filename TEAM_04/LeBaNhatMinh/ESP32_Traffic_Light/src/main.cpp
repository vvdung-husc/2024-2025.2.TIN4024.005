...
void loop() {
    ...
    if (currentState != lastState) {
        ...
        if (lastState == 0) Serial.println("Đèn xanh: OFF");
        if (lastState == 1) Serial.println("Đèn vàng: OFF");
        if (lastState == 2) Serial.println("Đèn đỏ: OFF");
        
        lastState = currentState;
        if (currentState == 0) Serial.println("Đèn xanh: ON");
        if (currentState == 1) Serial.println("Đèn vàng: ON");
        if (currentState == 2) Serial.println("Đèn đỏ: ON");
    }
