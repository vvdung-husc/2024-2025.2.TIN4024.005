...
// // Blynk credentials
// #define BLYNK_TEMPLATE_ID "TMPL65uSwRoHN"
// #define BLYNK_TEMPLATE_NAME "ESP32 Blynk Get API"
// #define BLYNK_AUTH_TOKEN "lZIPAgmN-ftZlai2fuOKegvVRNm4Mk44"
...
// const char *weatherApiKey = "fe20094faa908f1009b55dec0054f72e"; // Replace with your OpenWeatherMap API key
...
//     String weatherUrl = "https://api.openweathermap.org/data/2.5/weather?lat=" + lat + "&lon=" + lon + "&appid=" + weatherApiKey + "&units=metric"; // Metric units for temperature
...
//       // Parse temperature (basic parsing, assuming JSON format)
//       int tempIndex = weatherPayload.indexOf("\"temp\":") + 7;
//       int tempEndIndex = weatherPayload.indexOf(",", tempIndex);
//       String tempStr = weatherPayload.substring(tempIndex, tempEndIndex);
//       float temperature = tempStr.toFloat();

//       // Send temperature to Blynk
//       Blynk.virtualWrite(VPIN_TEMPERATURE, temperature);
//     } else {
//       Serial.printf("Lỗi HTTP (Weather API): %d\n", httpResponseCode);
//     }
//   } else {
