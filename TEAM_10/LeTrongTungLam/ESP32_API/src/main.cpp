...
#define BLYNK_TEMPLATE_ID "TMPL6vV2CR0mt"
#define BLYNK_TEMPLATE_NAME "ESP32API"
#define BLYNK_AUTH_TOKEN "6c5-w-GALD7S6okcvyIwbgJcMJreOIRM"
...
#define OPENWEATHERMAP_KEY "a36af7b135958e65d157f972e9f983e7" //Thay KEY của bạn vào đây
...
void updateTemp(){
  ...
  if(httpResponseCode > 0){
    ...
    if (temp_ != temp) {  
      ...
      Blynk.virtualWrite(V0, temp_);  // Gửi lên Blynk
    }
  } else {
...
void onceCalled(){
  ...
  Blynk.virtualWrite(V2, ip4Info.ip4.c_str());  //Gửi giá trị lên chân ảo V1 trên ứng dụng Blynk.
...
void uptimeBlynk(){
  ...
  Blynk.virtualWrite(V1, value);  //Gửi giá trị lên chân ảo V0 trên ứng dụng Blynk.
}
